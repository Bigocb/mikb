    ...
    <article>
        <div class="dash" v-if="showPlaces == false">
            <div v-for="post in posts" v-bind:key="post.id">
                <span class="badge badge-pill badge-warning tags"><a href="#" @click.prevent="populatePostToEdit(post)"> <img
                        src="../../assets/png/pencil-2x.png"></a></span>
                <span class="badge badge-pill badge-warning tags"> <a v-if="post.approved === null" href="#"
                                                                      @click.prevent="approvePost(post.id)"><img
                        src="../../assets/png/check-2x.png"></a></span><span
                    class="badge badge-pill badge-warning tags"><a href="#" @click.prevent="deletePost(post.id)"> <img
                    src="../../assets/png/delete-2x.png"></a> </span>
            ...
            <router-link :to="'/tags/' + list">
                ...
                <a id="popoverButton-sync2" variant="primary" class="badge badge-pill badge-warning tags" href="#">Add
                    to List</a>
                <b-popover triggers="click" :show.sync="showList" target="popoverButton-sync2" title="Add To List">
                    ...
                    <a href="#" @click.prevent="addToList(addList.listid,post.id,post.title)"> <img
                            src="../../assets/png/check-2x.png"></a>
                </b-popover>
            ...
            <router-link :to="'/tags/' + tag">
                ...
                </span><a id="popoverButton-sync" variant="primary" @click="showAddTags = true"
                          class="badge badge-pill badge-warning tags" href="#">add</a>
                ...
                <div class="alert alert-dismissible alert-secondary">
                    <p @dblclick="populatePostToEdit(post)" v-highlightjs class="post-content" v-html="marked(post.task)"></p>
                </div>
        ...
        <div class="dash" v-if="showPlaces == true">
            ...
            <form @submit.prevent="savePost">
                <b-btn class="badge badge-pill badge-warning tags" @click="showPlaces = false" type="submit"
                       variant="success"><img src="../../assets/png/check-2x.png"></b-btn>
                <h4>Tags:</h4><span class="badge badge-pill badge-success tags" v-for="tag in splitJoin(model.tags)"
                                    v-text="tag"></span>
                <b-form-group>
