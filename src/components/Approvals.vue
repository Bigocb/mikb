    ...
    <b-row>
      <b-col>
        ...
        <div class="list-group">
          <v-client-table :data="posts" :columns="columns">
            ...
            <a  slot="approve" slot-scope="props"  href="#" @click.prevent="approvePost(props.row.id)">Approve</a>
            <div slot="child_row" slot-scope="props">
         <div v-if="showPlaces == false">
              <p v-highlightjs v-html="marked(props.row.task)"></p>
              <p v-html="props.row.lastupdate"></p>
              <a @click.prevent="populatePostToEdit(props.row)">Edit</a> - <a slot="delete" slot-scope="props" href="#" @click.prevent="deletePost(props.row.id)">delete</a>
              </div>
...
<script>
  ...
  export default {
    data() {
      ...
      return {
        sortKey: '',
        columns: ['title','category','delete','approve'],
        reverse: false,
        search: '',
        showPlaces: false,
        loading: false,
    ...
    methods: {
      ...
      async refreshPosts() {
        this.temp = await apiOkta.getUser()
        this.family = await api.getFamily(this.temp.profile.email)
        this.posts = await api.getApprovalPosts(this.family.familyid)
      },
