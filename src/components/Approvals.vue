      ...
      <b-col>
        <div class="list-group">
          <v-client-table :data="posts" :columns="columns">
            ...
            <a slot="delete" slot-scope="props" href="#" @click.prevent="deletePost(props.row.id)">
              <img
                src="https://www.freeiconspng.com/uploads/remove-icon-png-24.png"
                height="42"
                width="42"
              >
            </a>
